...
### <span style="color: purple;">2) Multiple Iinitialization</span>

Since the MIxture of gaussians EM is very sensitive to the intialization parameters, there are multiple solutions that can be considered like:
...
### <span style="color: purple;">3) AIC & BIC</span>
