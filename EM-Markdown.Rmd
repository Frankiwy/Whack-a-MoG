...
Below are reported three lists containing the top 3 MoGs for each sample data.
```{r include=TRUE, message=FALSE, eval=FALSE, class.source="bg-success"}
